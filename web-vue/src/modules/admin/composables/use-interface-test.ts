/**
 * modules/admin/composables/use-interface-test.ts — 单接口测试 vue-query mutation
 *
 * 平移自 React 版 web/src/hooks/use-interface-test.ts，行为契约一致。
 * 对应后端 POST /api/admin/quote-interfaces/{id}/test。
