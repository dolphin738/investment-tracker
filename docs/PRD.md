...
> **版本**：v3.1.6（Consolidated / 单一权威版）
> **作者**：产品经理 许清楚（Alice）
> **日期**：2026-08-03
> **修订史（完整版）**：每版变更说明 + ID 核算已迁出至 **[docs/PRD-CHANGELOG.md](./PRD-CHANGELOG.md)**（最新为 v3.1.6）。
> **近期变更（v3.1.6）**：结构性重构 —— 修订史与 §13 覆盖对照析出至独立文档，附录 E 标注契约权威源；无需求 ID 增减。
> **语言**：中文（简体）
