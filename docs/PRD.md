...
> 🔴 **遗漏 = 0，达成交付标准。** 三份来源共 **235 个**需求 / 约束 / 决策 / 风险 / 问题 / 规格条目全部在本 PRD 落位，另加 v3.1.0 新增派生 ID **2 个**、v3.1.1 新增派生 ID **2 个**，合计 **239**（实际枚举表格行 **220 行**，其中 7 行将多个用户故事 / 问题 ID 归并为一行，如 `US-D1~US-D5`、`Q-01~Q-14`）。含明确改判 / 废止并记录的 D-01、HOLD-P0-02/05/07、D-04、D-05、C-09、TXN 模块并入等。
>
