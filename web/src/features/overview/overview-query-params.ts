/**
 * features/overview/overview-query-params.ts — 概览页 URL 查询状态（T03 · AL-014）
 *
 ...
 * 说明：当前 UI 仅提供快捷范围下拉（无自定义范围输入），from/to 主要为
 * 「复制链接 / 分享」场景保留 —— range=custom 且 from/to 合法时页面直接采用。
 */
