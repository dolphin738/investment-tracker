/**
 * features/holdings/trade-security-filter.ts — 统一筛选器 →「买卖明细」标的过滤派生
 *
...
// 三态语义与 SecurityTradeList 的 props 契约同源，避免两处各写一份字面量联合
import type { TradeFilterState } from '@/features/security-trade/security-trade-list';
